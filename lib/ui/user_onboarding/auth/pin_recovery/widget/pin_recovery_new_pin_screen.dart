...
class PinRecoveryNewPinScreen extends HookConsumerWidget {
  const PinRecoveryNewPinScreen({super.key});
                        ...
                        FilledButton(
                          onPressed: state.status is AsyncLoading
                              ...
                              : () {
                                  ...
                                  vm.saveNewPinAndContinue(pin);
                                  vm.goToNextStep();
                                  context.push('/pin-recovery-confirm-pin');
                                },
